...
const Courses = () => {
  return (
    <div className=" bg-skin-pink-200 py-10 border-b-[2px] border-black/30">
      <div className="flex container flex-col-reverse lg:flex-row justify-between gap-8 items-center">
        <div className="w-full space-y-2  lg:max-w-[850px]">
          <h3 className="heading-2">Courses and Newsletters</h3>
          <p>
            Share your expertise and create valuable learning experiences with
            our customized course development services. We collaborate with you
